...
import { Shield, Star, Trophy, ThumbsUp, MapPin } from 'lucide-react';
import Marquee from 'react-fast-marquee';
import CountUp from 'react-countup';

export default function TrustIndicators() {
  const stats = [
    { number: '8k+', label: 'Autos in Bremen angekauft' },
  ...
  const districts = [
    'Neustadt', 'Schwachhausen', 'Findorff', 'Walle',
    'Vahr', 'Hemelingen', 'Gröpelingen', 'Obervieland',
    'Horn-Lehe', 'Burglesum', 'Vegesack', 'Blumenthal'
  ];
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="flex flex-wrap justify-center gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Bremern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
