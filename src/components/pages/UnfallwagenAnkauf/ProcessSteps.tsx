...
const steps = [
  ...
  {
    icon: Wrench,
    title: 'Unfallwagen bewerten',
    description: 'Professionelle Bewertung des Unfallschadens durch unsere Experten.',
    benefits: ['Faire Bewertung', 'Transparente Preise', 'Alle Unfallarten']
  },
  {
    icon: BadgeEuro,
    ...
    <ParallaxProvider>
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1597328290883-50c5787b7c7e')" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihren Unfallwagen bei uns
            </motion.p>
          </div>
