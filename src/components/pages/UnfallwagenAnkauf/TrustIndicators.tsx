...
import { Star, Trophy, ThumbsUp, Wrench } from 'lucide-react';
import Marquee from 'react-fast-marquee';
import CountUp from 'react-countup';

export default function TrustIndicators() {
  const stats = [
    { number: '3000+', label: 'Unfallwagen angekauft' },
  ...
  const damageTypes = [
    'Frontschaden', 'Heckschaden', 'Seitenschaden', 'Totalschaden',
    'Motorschaden', 'Getriebeschaden', 'Hagelschaden', 'Brandschaden',
    'Wasserschaden', 'Sturmschaden', 'Parkschaden', 'Transportschaden'
  ];
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="flex flex-wrap justify-center gap-8">
          {[
            ...
            { icon: Wrench, text: 'Professionelle Begutachtung' },
