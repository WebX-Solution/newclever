...
export default function Districts() {
  const districts = [
    {
      name: 'Innenstadt',
      areas: ['Altstadt', 'Bahnhofsviertel', 'Gallus', 'Gutleutviertel'],
      description: 'Direkt im Bankenviertel - Ankauf binnen 30 Minuten',
      highlights: ['Soforttermin möglich', 'Bankennahe Abwicklung', 'Expressgutachten']
    },
    {
      name: 'Bockenheim',
      areas: ['Bockenheim', 'Westend', 'Kuhwald', 'Industriehof'],
      description: 'Universitätsnahes Expertenteam für schnelle Abwicklung',
      highlights: ['Digitale Bewertung', 'Studentenfreundlich', 'Flexibler Service']
    },
    {
      name: 'Sachsenhausen',
      areas: ['Alt-Sachsenhausen', 'Sachsenhausen-Nord', 'Sachsenhausen-Süd', 'Oberrad'],
      description: 'Mainufer-Service mit Sofortbewertung',
      highlights: ['Mainblick-Vorort-Check', 'Business-Fahrzeuge', 'Direktauszahlung']
    },
    {
      name: 'Nordend',
      areas: ['Nordend-West', 'Nordend-Ost', 'Bornheim', 'Ostend'],
      description: 'Premium-Ankauf im Frankfurter Lifestyle-Viertel',
      highlights: ['Luxusfahrzeuge', 'VIP-Service', 'Diskrete Abwicklung']
    },
    {
      name: 'Westend',
      areas: ['Westend-Süd', 'Westend-Nord', 'Palmengarten', 'Messe'],
      description: 'Messenähe - Ankauf auch während Großevents',
      highlights: ['Messespezial-Service', 'International', 'Mehrsprachig']
    },
    {
      name: 'Bornheim',
      areas: ['Bornheim', 'Seckbach', 'Berkersheim', 'Preungesheim'],
      description: 'Traditioneller Ankauf im Herzen Bornheims',
      highlights: ['Familiäre Beratung', 'Lokale Expertise', 'Bergesweg-Service']
    },
    {
      name: 'Rödelheim',
      areas: ['Rödelheim', 'Hausen', 'Praunheim', 'Westhausen'],
      description: 'Gewerbegebiet-Spezialist für Firmenfahrzeuge',
      highlights: ['Flottenankauf', 'B2B-Service', 'Gewerbefokus']
    },
    {
      name: 'Bergen-Enkheim',
      areas: ['Bergen', 'Enkheim', 'Fechenheim', 'Riederwald'],
      description: 'Östlicher Stadtrand - flexible Terminplanung',
      highlights: ['Randlagen-Service', 'Mobiler Ankauf', 'Peripherie-Experten']
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
          ...
          >
            ...
            <span className="text-primary text-sm sm:text-base font-medium">Alle Frankfurter Stadtteile</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
