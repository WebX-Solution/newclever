    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1662727466464-c8ec863b1a25?q=80&w=2105&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf Frankfurt</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Ankauf im Herzen der Finanzmetropole</span>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Professioneller Autoankauf am Finanzplatz Frankfurt mit 
                  <span className="text-primary font-medium"> Sofort-Banking</span>. 
                  Von der EZB bis zur Börse - wir sind in 30 Minuten bei Ihnen.
                </p>
              </div>
                ...
                {[
                  {
                    icon: Car,
                    title: 'Main-Express',
                    description: 'Vor-Ort Service im Bankenviertel',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Trading-Preise',
                    description: 'Börsenaktuelle Fahrzeugbewertung',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Finanzplatz-Service',
                    description: 'Digitale Sofortüberweisung',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Standort-Plus',
                    description: 'Mainhattan Coverage 24/7',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
