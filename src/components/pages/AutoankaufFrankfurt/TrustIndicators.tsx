...
export default function TrustIndicators() {
  const stats = [
    { number: '8000+', label: 'Autos in Frankfurt angekauft' },
  ...
  const districts = [
    'Innenstadt', 'Bockenheim', 'Sachsenhausen', 'Nordend',
    'Westend', 'Bornheim', 'Rödelheim', 'Gallus',
    'Höchst', 'Niederrad', 'Bergen-Enkheim', 'Ostend'
  ];
      ...
      <div className="container mx-auto px-4 mb-8 sm:mb-12 md:mb-16">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Frankfurtern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
