...
const steps = [
  {
    ...
    description: 'Schnellster Banking-Service für Ihren Autoverkauf.',
    benefits: ['Real-Time Beratung', 'Trading-Desk Hotline', 'Digitaler Support']
  },
  {
    icon: Car,
    title: 'Präzise Bewertung',
    description: 'Finanzplatz-Standard mit Live-Marktdaten.',
    benefits: ['Echtzeit-Bewertung', 'Börsenaktuelle Preise', 'Marktanalyse-Tool']
  },
  {
    icon: BadgeEuro,
    title: 'Prime-Angebot',
    description: 'Mainhattan-Premium für Ihr Fahrzeug.',
    benefits: ['Top-Deal Garantie', 'Banken-Level Service', 'Sofort-Entscheidung']
  },
  {
    icon: Banknote,
    title: 'Express-Banking',
    description: 'Direktes Settlement wie an der Börse.',
    benefits: ['Instant-Payment', 'Same-Day Clearing', 'Finanz-Garantie']
  }
];
    ...
    <ParallaxProvider>
      <section className="py-12 sm:py-20 md:py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1662727466464-c8ec863b1a25')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihr Auto in Frankfurt bei uns
            </motion.p>
          </div>
          ...
          >
            {[
              ...
              { icon: MapPin, text: 'Alle Frankfurter Stadtteile' }
            ].map((indicator, index) => (
