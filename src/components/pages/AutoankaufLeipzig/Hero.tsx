    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1702725186482-e29ef2bcabb1?q=80&w=1957&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf Leipzig</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Leipziger Autoankauf</span>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Vom Plagwitzer Industrieviertel bis zur Messestadt - 
                  <span className="text-primary font-medium"> faire Preise</span> für 
                  Ihren Gebrauchten. Direkt. Regional. Traditionsbewusst.
                </p>
              </div>
            ...
            >
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  {
                    icon: Car,
                    title: 'Leipziger Tradition',
                    description: 'Seit der Wende Ihr Partner im Autoankauf',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Messestadt-Preise',
                    description: 'Faire Bewertung nach Leipziger Standard',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Ost-Expertise',
                    description: 'Spezialist für DDR-Klassiker & Moderne',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Überall vor Ort',
                    description: 'Von Grünau bis zur Südvorstadt',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
