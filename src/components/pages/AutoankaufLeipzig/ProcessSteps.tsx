...
const steps = [
  {
    ...
    description: 'Schnelle und einfache Kontaktaufnahme per Telefon oder Online-Formular.',
    benefits: ['Sofortige Rückmeldung', 'Freundlicher Service', 'Individuelle Beratung']
  },
  {
    icon: Car,
    title: 'Fahrzeugbewertung',
    description: 'Professionelle Bewertung Ihres Fahrzeugs durch unsere Experten.',
    benefits: ['Kostenlose Begutachtung', 'Transparente Bewertung', 'Marktgerechter Preis']
  },
  {
    icon: BadgeEuro,
    title: 'Preisangebot',
    description: 'Erhalten Sie ein faires und verbindliches Preisangebot für Ihr Fahrzeug.',
    benefits: ['Bestpreis-Garantie', 'Keine versteckten Kosten', 'Schnelle Abwicklung']
  },
  {
    icon: Banknote,
    title: 'Verkauf & Auszahlung',
    description: 'Verkaufen Sie Ihr Fahrzeug und erhalten Sie sofort Ihr Geld.',
    benefits: ['Sofortige Auszahlung', 'Unkomplizierte Abwicklung', 'Kostenlose Abholung']
  }
];
    ...
    <ParallaxProvider>
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1702725186482-e29ef2bcabb1?q=80&w=1957&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihr Auto in Leipzig bei uns
            </motion.p>
          </div>
          ...
          >
            {[
              ...
              { icon: MapPin, text: 'Alle Leipziger Stadtteile' }
            ].map((indicator, index) => (
