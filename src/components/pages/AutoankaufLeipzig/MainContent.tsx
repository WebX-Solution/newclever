...
export default function MainContent() {
  const serviceLinks = [
    { path: "/leipzig/gebrauchtwagen-ankauf", text: "Gebrauchtwagen Ankauf Leipzig" },
    { path: "/leipzig/unfallwagen-ankauf", text: "Unfallwagen Ankauf Leipzig" },
    { path: "/leipzig/firmenwagen-ankauf", text: "Firmenwagen Ankauf Leipzig" },
    { path: "/leipzig/motorschaden-ankauf", text: "Motorschaden Ankauf Leipzig" },
    { path: "/leipzig/kfz-ankauf", text: "KFZ Ankauf Leipzig" },
    { path: "/leipzig/pkw-ankauf", text: "PKW Ankauf Leipzig" },
  ];

  const features = [
    {
      icon: Car,
      title: 'Leipziger Tempo',
      description: 'Direkt & Zuverlässig',
      benefits: [
        'Abholung in 30 Minuten',
        'Bezahlung vor Ort',
        'Abmeldung am selben Tag',
        'Nacht-Service bis 22 Uhr'
      ]
    },
    {
      icon: BadgeEuro,
      title: 'Echte Bestpreise',
      description: 'Ohne Preisdrückerei',
      benefits: [
    ...
    {
      icon: Shield,
      title: 'Leipziger Original',
      description: 'Ihr Ankauf vor Ort',
      benefits: [
        'Seit 12 Jahren hier',
  ...
  const mainContentText = {
    title: "Autoankauf Leipzig - Heute anrufen, heute verkaufen",
    paragraphs: [
      "Kein Herumfahren zu dubiosen Händlern. Vom Zentrum bis Plagwitz, von Schleußig bis Gohlis: In 30 Minuten sind wir bei Ihnen. Mit Sofortbewertung und Barzahlung. Ihre Zeit ist zu wertvoll für lange Besichtigungen.",
      
      "Wir machen's kurz: Sie zeigen das Auto, wir nennen den Preis, Sie entscheiden sofort. Keine versteckten Gebühren, keine endlosen Diskussionen. Was wir zusagen, wird gezahlt - ob bar oder Express-Überweisung.",
      
      "Perfekt für Berufstätige: Wir kommen auch nach 18 Uhr oder am Wochenende. Egal ob Gebrauchter, Unfallwagen oder mit Motorschaden - wir kaufen jedes Auto. Komplette Abwicklung in einer Stunde, inklusive Abmeldung."
    ]
  };

  const specializedServicesContent = {
    title: "Ankauf überall in Leipzig",
    description: "Von der Karli bis zur Georg-Schumann-Straße, vom Hauptbahnhof bis zum BMW-Werk: Unser Team kommt zu Ihnen. Mit fairer Bewertung und Express-Bezahlung machen wir Ihren Autoverkauf zum Kinderspiel."
  };

  const regionalExpertiseContent = {
    title: "Leipzig und Umland",
    description: "Ob in der City oder im Speckgürtel - wir sind schnell vor Ort. Mit digitaler Sofortabwicklung und flexiblen Terminen machen wir den Verkauf so einfach wie möglich."
  };

  const relatedServicesContent = {
    title: "Verwandte Dienstleistungen",
    description: "Entdecken Sie unsere spezialisierten Dienstleistungen für den Autoankauf in Leipzig und Umgebung."
  };
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              ...
              <span className="text-primary text-sm sm:text-base font-medium">Autoankauf Experten Leipzig</span>
            </motion.div>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Profitieren Sie von unserem professionellen Autoankauf Service in Leipzig.
          ...
          <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 md:space-y-20">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    { to: "/leipzig/motorschaden-ankauf", text: "Motorschaden Ankauf", icon: Car },
                    { to: "/leipzig/kfz-ankauf", text: "KFZ Ankauf", icon: BadgeCheck },
                    { to: "/leipzig/pkw-ankauf", text: "PKW Ankauf", icon: Shield }
                  ].map((service, index) => (
                    <Link
                      key={index}
                      to={service.to}
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 sm:mb-6 relative z-10">
                Jetzt Auto in Leipzig verkaufen
              </h3>
              <p className="text-sm sm:text-base md:text-xl text-gray-300 mb-4 sm:mb-8 max-w-2xl mx-auto relative z-10">
                ...
                Wir sind in ganz Leipzig für Sie da.
              </p>
