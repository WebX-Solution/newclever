...
export default function TrustIndicators() {
  const stats = [
    { number: '8000+', label: 'Autos in Leipzig angekauft' },
  ...
  const districts = [
    'Zentrum-Nord', 'Zentrum-Süd', 'Plagwitz', 'Connewitz',
    'Gohlis', 'Stötteritz', 'Reudnitz', 'Lindenau',
    'Schleußig', 'Mockau', 'Grünau', 'Leutzsch'
  ];
      ...
      <div className="container mx-auto px-4 mb-8 sm:mb-12 md:mb-16">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Leipzigern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
