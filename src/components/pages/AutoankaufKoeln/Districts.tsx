...
export default function Districts() {
  const districts = [
    {
      name: 'Innenstadt',
      areas: ['Altstadt-Nord', 'Altstadt-Süd', 'Neustadt-Nord', 'Neustadt-Süd'],
      description: 'Dom-Service mit Expressbewertung',
      highlights: ['City-Terminal', 'Dom-Logistik', 'Veedel-Express']
    },
    {
      name: 'Ehrenfeld',
      areas: ['Ehrenfeld', 'Neuehrenfeld', 'Bickendorf', 'Ossendorf'],
      description: 'Kreativ-Viertel Spezialankauf',
      highlights: ['Szene-Service', 'Start-up Support', 'Künstler-Komfort']
    },
    {
      name: 'Nippes',
      areas: ['Nippes', 'Mauenheim', 'Riehl', 'Niehl'],
      description: 'Rheinufer-Service mit Sofortankauf',
      highlights: ['Hafennähe', 'Industrie-Express', 'Veedel-Vor-Ort']
    },
    {
      name: 'Mülheim',
      areas: ['Mülheim', 'Buchheim', 'Buchforst', 'Höhenhaus'],
      description: 'Rechtsrheinischer Expressankauf',
      highlights: ['Mülheimer Brücke', 'Gewerbe-Service', 'Schnellabwicklung']
    },
    {
      name: 'Lindenthal',
      areas: ['Lindenthal', 'Braunsfeld', 'Müngersdorf', 'Junkersdorf'],
      description: 'Uni-Viertel Premium Service',
      highlights: ['Campus-Express', 'Akademiker-Service', 'Studenten-Support']
    },
    {
      name: 'Chorweiler',
      areas: ['Chorweiler', 'Seeberg', 'Heimersdorf', 'Worringen'],
      description: 'Nord-Express mit Sofortbewertung',
      highlights: ['Ford-Werk-Nähe', 'Industrie-Expertise', 'Nordstadt-Mobil']
    },
    {
      name: 'Porz',
      areas: ['Porz', 'Urbach', 'Eil', 'Grengel'],
      description: 'Airport-City Schnellankauf',
      highlights: ['Flughafen-Service', 'Airport-Express', 'Business-Support']
    },
    {
      name: 'Kalk',
      areas: ['Kalk', 'Humboldt/Gremberg', 'Vingst', 'Höhenberg'],
      description: 'Industrie-Viertel Spezialservice',
      highlights: ['Gewerbepark-Ankauf', 'B2B-Express', 'Veedel-Logistik']
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
          ...
          >
            ...
            <span className="text-primary text-sm sm:text-base font-medium">Alle Kölner Stadtteile</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Wir sind in allen Kölner Stadtteilen für Sie da
          </motion.p>
        </div>
