...
export default function FAQ() {
  const faqs = [
    {
      question: 'Wie läuft der Autoankauf in Köln ab?',
      answer: 'Der Ankaufsprozess ist einfach und unkompliziert: Sie kontaktieren uns telefonisch oder über das Formular. Wir erstellen eine erste Einschätzung und vereinbaren einen Vor-Ort Termin in Köln zur detaillierten Begutachtung. Nach der Bewertung erhalten Sie ein verbindliches Kaufangebot. Bei Einigung erfolgt die sofortige Bezahlung und kostenlose Abholung.'
    },
    {
      question: 'In welchen Kölner Stadtteilen sind Sie tätig?',
      answer: 'Wir sind in allen Kölner Stadtteilen aktiv: Innenstadt, Ehrenfeld, Nippes, Mülheim, Lindenthal, Chorweiler, Porz, Kalk, Rodenkirchen, Deutz, Sülz und vielen weiteren.'
    },
    {
      question: 'Wie wird der Preis für mein Auto ermittelt?',
      answer: 'Die Preisermittlung basiert auf verschiedenen Faktoren: Fahrzeugmodell, Alter, Kilometerstand, Ausstattung und Zustand. Unsere Kölner Experten führen eine professionelle Begutachtung durch und berücksichtigen aktuelle Marktpreise für eine faire Bewertung.'
    },
    {
      question: 'Kaufen Sie auch Unfallwagen und defekte Fahrzeuge?',
      answer: 'Ja, wir kaufen auch Unfallfahrzeuge, Fahrzeuge mit Motorschaden oder anderen technischen Defekten in Köln an. Eine faire Bewertung erfolgt nach Begutachtung des Schadens.'
    },
    {
      question: 'Wie schnell erfolgt die Abwicklung in Köln?',
      answer: 'Wir bieten einen Express-Service mit Abwicklung innerhalb von 24 Stunden. Nach der Begutachtung und Einigung erfolgt die sofortige Bezahlung per Bargeld oder Express-Überweisung. Die Abholung wird kostenlos und zeitnah in ganz Köln organisiert.'
    },
    {
    ...
    <section className="py-12 sm:py-20 md:py-32 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
          ...
          >
            Hier finden Sie Antworten auf die wichtigsten Fragen rund um den Autoankauf in Köln
          </motion.p>
        </div>
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg sm:rounded-xl md:rounded-3xl p-4 sm:p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4 sm:space-y-6">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-4">
                Noch Fragen zum Autoankauf in Köln?
              </h3>
              <p className="text-sm sm:text-base md:text-xl text-gray-300 mb-4 sm:mb-6 md:mb-8 max-w-2xl mx-auto">
                ...
                Unsere Kölner Experten stehen Ihnen jederzeit zur Verfügung.
              </p>
