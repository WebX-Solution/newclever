    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1561624485-0e43bcc1836d?auto=format&fit=crop&q=80)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf Köln</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Autoankauf im Herzen des Rheinlands</span>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Von Ehrenfeld bis Deutz - 
                  <span className="text-primary font-medium"> kölsche Kompetenz</span> beim Autoankauf. 
                  Direkt, fair und schnell wie der Express am Dom.
                </p>
              </div>
            ...
            >
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  {
                    icon: Car,
                    title: 'Veedels-Express',
                    description: 'Service in allen Stadtteilen',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Kölsche Preise',
                    description: 'Fair und transparent',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Rheinland-Service',
                    description: 'Kompetenz seit 20 Jahren',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Dom-Coverage',
                    description: 'Zentral bis Vorort',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
