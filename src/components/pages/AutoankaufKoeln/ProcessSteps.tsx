...
const steps = [
  {
    ...
    description: 'Schnelle Kontaktaufnahme - von der Südstadt bis Chorweiler, wir sind für Sie da.',
    benefits: ['Rund um die Uhr für Sie da', 'Direkte Expertenverbindung', 'WhatsApp oder Anruf']
  },
  {
    icon: Car,
    title: 'Vor-Ort Check',
    description: 'Professionelle Begutachtung - direkt bei Ihnen oder an unserem Kölner Standort.',
    benefits: ['Modernste Diagnosetechnik', 'Transparente Analyse', 'Faire Restwertermittlung']
  },
  {
    icon: BadgeEuro,
    title: 'Kölsche Fairness',
    description: 'Marktgerechte Preise ohne Wenn und Aber - so läuft das bei uns in Köln.',
    benefits: ['Regionale Marktwertanalyse', 'Sofortiges Festpreisangebot', 'Keine Nachverhandlungen']
  },
  {
    icon: Banknote,
    title: 'Express-Abwicklung',
    description: 'Binnen 60 Minuten ist Ihr Auto verkauft und das Geld auf Ihrem Konto.',
    benefits: ['Sofort-Überweisung', 'Gratis Abmeldung', 'Blitzschnelle Abholung']
  }
];
    ...
    <ParallaxProvider>
      <section className="py-12 sm:py-20 md:py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1561624485-0e43bcc1836d')] bg-cover bg-center bg-no-repeat opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihr Auto in Köln bei uns
            </motion.p>
          </div>
