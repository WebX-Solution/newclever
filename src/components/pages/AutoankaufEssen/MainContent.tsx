...
export default function MainContent() {
  const serviceLinks = [
    { path: "/essen/gebrauchtwagen-ankauf", text: "Gebrauchtwagen Ankauf Essen" },
    { path: "/essen/unfallwagen-ankauf", text: "Unfallwagen Ankauf Essen" },
    { path: "/essen/firmenwagen-ankauf", text: "Firmenwagen Ankauf Essen" },
    { path: "/essen/motorschaden-ankauf", text: "Motorschaden Ankauf Essen" },
    { path: "/essen/kfz-ankauf", text: "KFZ Ankauf Essen" },
    { path: "/essen/pkw-ankauf", text: "PKW Ankauf Essen" },
  ];

  const features = [
    {
      icon: Car,
      title: 'Essener Autoankauf-Experten',
      description: 'Professioneller Autoankauf im Herzen des Ruhrgebiets',
      benefits: [
        'Express-Service im Ruhrpott',
        'Sofortige Barzahlung',
        'Industriestadt-Expertise',
        'Kostenlose Vor-Ort Bewertung'
      ]
    },
    {
      icon: BadgeEuro,
      title: 'Ruhrgebiets-Bestpreise',
      description: 'Faire Preise durch lokale Marktkenntnisse',
      benefits: [
        'Regionale Marktanalyse',
        'Ruhrgebiets-Erfahrung',
        'Transparente Preise',
        'Bestpreis-Garantie'
      ]
    },
    {
      icon: Shield,
      title: 'Essener Premium-Service',
      description: 'Ihr Partner in der Einkaufsmetropole',
      benefits: [
        'Zentrale Lage',
        'Rechtssichere Verträge',
        '9.000+ Kunden in Essen'
      ]
    }
  ];

  const mainContentText = {
    title: "Autoankauf Essen - Ihr Experte im Ruhrgebiet",
    paragraphs: [
      "Als führender Autoankäufer in Essen verbinden wir Ruhrgebiets-Tradition mit modernem Service. Unser Standort im Zentrum der Metropolregion und die hervorragende Infrastruktur ermöglichen uns, schnell und flexibel auf Ihre Anfragen zu reagieren. Durch unsere langjährige Präsenz im Essener Automarkt kennen wir die lokalen Besonderheiten und bieten Ihnen Bestpreise.",
      
      "Die zentrale Lage Essens als wichtige Handelsmetropole prägt unseren Service. Von Privatfahrzeugen über Dienstwagen bis zu Flottenfahrzeugen - unser Ankaufsservice profitiert von der dynamischen Wirtschaftsregion und der ausgezeichneten Verkehrsanbindung. Dies ermöglicht uns besonders attraktive Ankaufskonditionen.",
      
      "Von Rüttenscheid bis Kettwig, von Werden bis Altenessen - unser mobiles Team ist in allen Essener Stadtteilen präsent. Die optimale Anbindung durch die A40, A42 und A52 sowie die zentrale Lage im Ruhrgebiet garantieren schnelle Reaktionszeiten und flexible Terminvereinbarungen. Profitieren Sie von unserem kostenlosen Vor-Ort-Service mit Ruhrgebiets-Expertise."
    ]
  };

  const specializedServicesContent = {
    title: "Spezialisierter Fahrzeugankauf in der Ruhrmetropole",
    description: "Als Essener Autoankauf-Spezialist bieten wir besondere Expertise im Ankauf von Stadt- und Flottenfahrzeugen. Unsere zentrale Position im Ruhrgebiet ermöglicht uns, Bestpreise auch für spezielle Fahrzeugtypen zu realisieren."
  };

  const regionalExpertiseContent = {
    title: "Ruhrgebiets-Kompetenz",
    description: "Mit unserer Verwurzelung in Essen verbinden wir Ruhrgebiets-Tradition mit modernem Service. Von der Zeche Zollverein bis zur Einkaufsmeile - wir sind Ihr lokaler Partner für den Autoankauf."
  };

  const relatedServicesContent = {
    title: "Verwandte Dienstleistungen",
    description: "Entdecken Sie unsere spezialisierten Dienstleistungen für den Autoankauf in Essen und Umgebung."
  };
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              ...
              <span className="text-primary text-sm sm:text-base font-medium">Autoankauf Experten Essen</span>
            </motion.div>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Profitieren Sie von unserem professionellen Autoankauf Service in Essen.
          ...
          <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 md:space-y-20">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    { to: "/essen/motorschaden-ankauf", text: "Motorschaden Ankauf", icon: Car },
                    { to: "/essen/kfz-ankauf", text: "KFZ Ankauf", icon: BadgeCheck },
                    { to: "/essen/pkw-ankauf", text: "PKW Ankauf", icon: Shield }
                  ].map((service, index) => (
                    <Link
                      key={index}
                      to={service.to}
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-xl text-gray-300 mb-4 sm:mb-8 max-w-2xl mx-auto relative z-10">
                ...
                Wir sind in ganz Essen für Sie da.
              </p>
