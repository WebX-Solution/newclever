...
export default function TrustIndicators() {
  const stats = [
    { number: '6000+', label: 'Autos in Essen angekauft' },
  ...
  const districts = [
    'Rüttenscheid', 'Steele', 'Borbeck', 'Frohnhausen',
    'Altenessen', 'Kettwig', 'Werden', 'Bredeney',
    'Holsterhausen', 'Katernberg', 'Stadtmitte', 'Kupferdreh'
  ];
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="flex flex-wrap justify-center gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Essenern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
