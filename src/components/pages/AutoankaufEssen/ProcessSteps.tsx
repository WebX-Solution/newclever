...
const steps = [
  {
    ...
    description: 'Einfach und schnell per Telefon oder Formular.',
    benefits: ['Rund um die Uhr erreichbar', 'Sofortige Beratung', 'Kostenlos & unverbindlich']
  },
  {
    icon: Car,
    title: 'Fahrzeugbewertung',
    description: 'Expertenbewertung direkt in Essen.',
    benefits: ['Faire Preise', 'Transparente Bewertung', 'Alle Fahrzeugtypen']
  },
  {
    icon: BadgeEuro,
    title: 'Angebot erhalten',
    description: 'Bestes Angebot ohne versteckte Kosten.',
    benefits: ['Bestpreis-Garantie', 'Keine versteckten Gebühren', 'Sofortiges Angebot']
  },
  {
    icon: Banknote,
    title: 'Sofortige Auszahlung',
    description: 'Schnelle Abwicklung und sofortige Zahlung.',
    ...
    <ParallaxProvider>
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1603142512542-96e12983742e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihr Auto in Essen bei uns
            </motion.p>
          </div>
          ...
          >
            {[
              ...
              { icon: MapPin, text: 'Alle Essener Stadtteile' }
            ].map((indicator, index) => (
