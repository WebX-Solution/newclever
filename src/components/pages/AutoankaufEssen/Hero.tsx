    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1603142512542-96e12983742e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf im Herzen des Ruhrgebiets</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Autoankauf Essen</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dark">
                    <TypeAnimation
                      sequence={[
                        'Zeche-Zollverein-Express',
                        2000,
                        'Ruhrpott-Direktkauf',
                        2000,
                        'Essener Bestpreis',
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Von Rüttenscheid bis zum Baldeneysee – 
                  <span className="text-primary font-medium"> Sofort-Service in 30 Minuten</span>. 
                  Autoankauf mit Ruhrgebiets-Tempo.
                </p>
              </div>
            ...
            >
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  {
                    icon: Car,
                    title: 'Ruhrpott-Service',
                    description: 'Von Kleinwagen bis SUV',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Zechen-Bonus',
                    description: 'Extrapreise im Revier',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Pott-Partner',
                    description: 'Tradition seit 1990',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Revier-Express',
                    description: 'Von RWE bis Grugapark',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
