...
export default function MainContent({ city }: MainContentProps) { // city wird als Prop übergeben
  const features = [
    {
      icon: Car,
      title: `Alle PKW Typen in ${city}`,
      description: `Ankauf von PKWs aller Marken und Modelle in ${city}`,
      benefits: [
        'Limousinen & Kombis',
        'SUVs & Geländewagen',
        'Sportwagen & Cabrios',
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              ...
              <span className="text-primary font-medium">PKW Ankauf Experten in {city}</span>
            </motion.div>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              PKW Ankauf
              <span className="text-primary"> zum Bestpreis in {city}</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Profitieren Sie von unserem professionellen PKW Ankauf Service in {city}. Faire Preise und schnelle Abwicklung.
            </motion.p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-20">
            ...
            >
              <h3 className="text-3xl font-bold mb-6">
                Warum Sie Ihren PKW in {city} bei uns verkaufen sollten
              </h3>
              <p className="text-gray-600">
                Als erfahrener Partner im PKW Ankauf in {city} bieten wir Ihnen einen 
                professionellen und unkomplizierten Service. Wir kaufen Ihr Fahrzeug zu 
                fairen Marktpreisen und garantieren eine schnelle Abwicklung.
              </p>
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                {[ 
                  `Kostenlose Fahrzeugbewertung in ${city}`,
            ...
            >
              <h3 className="text-3xl font-bold mb-8">
                PKW Ankauf Service in {city}
              </h3>
              <p className="text-gray-600 mb-8">
                Unser PKW Ankauf Service ist in {city} verfügbar. Wir kommen kostenlos zu Ihnen und bewerten Ihr Fahrzeug vor Ort. 
                Profitieren Sie von unserem regionalen Service und verkaufen Sie Ihr Fahrzeug schnell und unkompliziert.
              </p>
              <div className="grid sm:grid-cols-2 gap-6">
                {[ 
                  { icon: MapPin, text: `Service in ${city}` },
                  { icon: Car, text: 'Vor-Ort Bewertung' },
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-white mb-6 relative z-10">
                Jetzt PKW in {city} verkaufen
              </h3>
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto relative z-10">
                Kontaktieren Sie uns für eine kostenlose Bewertung Ihres PKWs in {city}.
