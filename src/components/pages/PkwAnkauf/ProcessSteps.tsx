...
const steps = [
  ...
  },
  {
    ...
    benefits: ['Faire Bewertung', 'Transparente Preise', 'Alle PKW Typen']
  },
  {
    icon: BadgeEuro,
    ...
    <ParallaxProvider>
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihren PKW bei uns
            </motion.p>
          </div>
