...
import { Phone, BadgeEuro, Banknote, ArrowRight, Shield, Clock, Star, CheckCircle2, Wrench } from 'lucide-react';
...
const steps = [
  ...
  {
    icon: Wrench,
    title: 'Motorschaden bewerten',
    description: 'Professionelle Bewertung des Motorschadens durch unsere Experten.',
    benefits: ['Faire Bewertung', 'Transparente Preise', 'Alle Motorschäden']
  },
  {
    icon: BadgeEuro,
    ...
    <ParallaxProvider>
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihr Auto mit Motorschaden bei uns
            </motion.p>
          </div>
