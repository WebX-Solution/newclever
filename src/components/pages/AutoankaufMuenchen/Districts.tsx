...
export default function Districts() {
  const districts = [
    {
      name: 'Maxvorstadt',
      areas: ['Maxvorstadt', 'Königsplatz', 'Universität', 'Pinakotheken'],
      description: 'Kunst & Kultur trifft Autoankauf',
      highlights: ['Uni-Campus Service', 'Museumsviertel-Expertise', 'Kulturareal-Ankauf']
    },
    {
      name: 'Schwabing',
      areas: ['Schwabing-West', 'Schwabing-Nord', 'Münchner Freiheit', 'Leopoldstraße'],
      description: 'Bohème-Viertel Spezialist',
      highlights: ['Künstlerviertel-Service', 'Englischer Garten nah', 'Szene-Expertise']
    },
    {
      name: 'Altstadt-Lehel',
      areas: ['Altstadt', 'Lehel', 'Marienplatz', 'Isartor'],
      description: 'Premium-Service im Herzen Münchens',
      highlights: ['Rathaus-Nähe', 'Residenz-Service', 'Altstadtring-Abholung']
    },
    {
      name: 'Haidhausen',
      areas: ['Haidhausen', 'Franzosenviertel', 'Ostbahnhof', 'Max-Weber-Platz'],
      description: 'Französisches Viertel Experte',
      highlights: ['Gasteig-Area', 'Wiener-Platz-Service', 'Kulturzentrum-Nähe']
    },
    {
      name: 'Au-Harlaching',
      areas: ['Au', 'Harlaching', 'Nockherberg', 'Giesing'],
      description: 'Vom Nockherberg bis zur Isar',
      highlights: ['Paulaner-Express', 'Grünwald-Connection', 'Isar-Service']
    },
    {
      name: 'Sendling',
      areas: ['Sendling', 'Westpark', 'Harras', 'Mittersendling'],
      description: 'Traditionsviertel-Ankauf',
      highlights: ['Großmarkthallen-Service', 'Westpark-Abholung', 'Viertel-Kompetenz']
    },
    {
      name: 'Bogenhausen',
      areas: ['Bogenhausen', 'Arabellapark', 'Herzogpark', 'St. Emmeram'],
      description: 'Villen-Viertel Spezialist',
      highlights: ['Luxus-Service', 'Prominenten-Diskretion', 'Villengegend-Expertise']
    },
    {
      name: 'Neuhausen',
      areas: ['Neuhausen', 'Nymphenburg', 'Hirschgarten', 'Dom Pedro'],
      description: 'Schloss-Service Nymphenburg',
      highlights: ['Schlosspark-Nähe', 'Hirschgarten-Express', 'Königlicher Service']
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
          ...
          >
            ...
            <span className="text-primary text-sm sm:text-base font-medium">Alle Münchner Stadtteile</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Wir sind in allen Münchner Stadtteilen für Sie da
          </motion.p>
        </div>
