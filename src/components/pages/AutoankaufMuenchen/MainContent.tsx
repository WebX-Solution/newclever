...
export default function MainContent() {
  const serviceLinks = [
    { path: "/muenchen/gebrauchtwagen-ankauf", text: "Gebrauchtwagen Ankauf München" },
    { path: "/muenchen/unfallwagen-ankauf", text: "Unfallwagen Ankauf München" },
    { path: "/muenchen/firmenwagen-ankauf", text: "Firmenwagen Ankauf München" },
    { path: "/muenchen/motorschaden-ankauf", text: "Motorschaden Ankauf München" },
    { path: "/muenchen/kfz-ankauf", text: "KFZ Ankauf München" },
    { path: "/muenchen/pkw-ankauf", text: "PKW Ankauf München" },
  ];

  const features = [
    {
      icon: Car,
      title: 'München Express',
      description: 'Effizient & Verlässlich',
      benefits: [
        'Ankauf in 35 Minuten',
        'City & Umland-Service',
    ...
    {
      icon: BadgeEuro,
      title: 'Münchner Bestpreis',
      description: 'Mehr als marktüblich',
      benefits: [
        'Exportpreise inkludiert',
        'Zahlung nach Wunsch',
        'Preis-Plus-Garantie',
    ...
    {
      icon: Shield,
      title: 'Service mit Format',
      description: 'Typisch Münchnerisch',
      benefits: [
        'Komplett-Abwicklung',
        'Händlernetzwerk Bayern',
        'Ohne Zusatzkosten'
      ]
    }
  ];
  ...
  const mainContentText = {
    title: "Autoankauf München - schnell, direkt, professionell",
    paragraphs: [
      "Von Schwabing bis Sendling, von der Au bis nach Pasing: In 35 Minuten sind wir bei Ihnen. Mit Direktankauf und Sofortzahlung. Auch am Wochenende und nach Feierabend - perfekt für Berufstätige im Großraum München.",
      
      "Unser Münchner Plus: Wir vernetzen lokale Händler mit internationalen Märkten. Das bedeutet für Sie bis zu 15% mehr als der übliche Händlereinkaufspreis. Dank Express-Banking haben Sie das Geld noch am selben Tag auf Ihrem Konto.",
      
      "Kein Versteckspielen bei Mängeln: Ob Gebrauchtwagen, Unfallwagen oder mit Motorschaden - wir nennen Ihnen den realen Marktwert. Mit kostenloser Abmeldung. So geht moderner Autoverkauf in München."
    ]
  };

  const specializedServicesContent = {
    title: "Ihr Autoankauf-Partner in München",
    description: "Ob am Mittleren Ring oder in den Vororten: Unser mobiles Team kommt zu Ihnen. Mit Sofortbewertung, Express-Abwicklung und Bestpreis-Garantie machen wir den Autoverkauf so einfach wie nie."
  };

  const regionalExpertiseContent = {
    title: "München und Umgebung",
    description: "Vom Marienplatz bis ins Umland - wir sind überall für Sie da. Mit flexiblen Terminen und vollständiger Abwicklung vor Ort sparen Sie sich jeden unnötigen Weg."
  };

  const relatedServicesContent = {
    title: "Verwandte Dienstleistungen",
    description: "Entdecken Sie unsere spezialisierten Dienstleistungen für den Autoankauf in München und Umgebung."
  };
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              ...
              <span className="text-primary text-sm sm:text-base font-medium">Autoankauf Experten München</span>
            </motion.div>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Profitieren Sie von unserem professionellen Autoankauf Service in München.
          ...
          <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 md:space-y-20">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    { to: "/muenchen/motorschaden-ankauf", text: "Motorschaden Ankauf", icon: Car },
                    { to: "/muenchen/kfz-ankauf", text: "KFZ Ankauf", icon: BadgeCheck },
                    { to: "/muenchen/pkw-ankauf", text: "PKW Ankauf", icon: Shield }
                  ].map((service, index) => (
                    <Link
                      key={index}
                      to={service.to}
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 sm:mb-6 relative z-10">
                Jetzt Auto in München verkaufen
              </h3>
