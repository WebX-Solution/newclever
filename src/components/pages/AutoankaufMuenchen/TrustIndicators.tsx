...
export default function TrustIndicators() {
  const stats = [
    { number: '2000+', label: 'Autos in München angekauft' },
  ...
  const districts = [
    'Schwabing', 'Maxvorstadt', 'Bogenhausen', 'Sendling',
    'Neuhausen', 'Pasing', 'Riem', 'Moosach',
    'Giesing', 'Haidhausen', 'Ludwigsvorstadt', 'Laim'
  ];
      ...
      <div className="container mx-auto px-4 mb-8 sm:mb-12 md:mb-16">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Münchnern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
