...
import { Phone, Building2, BadgeEuro, Banknote, ArrowRight, Shield, Clock, Star, CheckCircle2 } from 'lucide-react';
...
const steps = [
  ...
  {
    icon: Building2,
    title: 'Fahrzeuge bewerten',
    description: 'Professionelle Bewertung Ihrer Firmenfahrzeuge durch unsere Experten.',
    ...
    <ParallaxProvider>
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1647281194826-11459827b123')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihre Firmenfahrzeuge bei uns
            </motion.p>
          </div>
