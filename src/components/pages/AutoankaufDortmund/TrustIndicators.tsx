...
export default function TrustIndicators() {
  const stats = [
    { number: '10000+', label: 'Autos in Dortmund angekauft' },
  ...
  const districts = [
    'Innenstadt', 'Hörde', 'Hombruch', 'Brackel',
    'Eving', 'Scharnhorst', 'Aplerbeck', 'Mengede',
    'Lütgendortmund', 'Huckarde', 'Dorstfeld', 'Kirchlinde'
  ];
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="flex flex-wrap justify-center gap-8">
          {[
            ...
            { icon: MapPin, text: 'Alle Dortmunder Stadtteile' },
            { icon: ThumbsUp, text: 'Empfohlen von Dortmundern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
