...
const steps = [
  {
    icon: Phone,
    title: 'Direkt durchstarten',
    description: 'Ein Anruf genügt - Ihr Dortmunder Autoankauf-Team ist sofort für Sie da.',
    benefits: ['Rund um die Uhr erreichbar', 'WhatsApp möglich', 'Direkte Preisauskunft']
  },
  {
    icon: Car,
    title: 'Vor-Ort Check',
    description: 'Kompetente Begutachtung direkt bei Ihnen im gesamten Dortmunder Stadtgebiet.',
    benefits: ['Keine Anfahrtskosten', 'Express-Termine möglich', 'TÜV-geprüfte Bewertung']
  },
  {
    icon: BadgeEuro,
    title: 'Marktgerechter Preis',
    description: 'Faire Bewertung nach aktueller Dortmunder Marktsituation - garantiert ohne Preisdrückerei.',
    benefits: ['Lokale Bestpreise', 'Sofort-Zusage', 'Transparente Kalkulation']
  },
  {
    icon: Banknote,
    title: 'Express-Abwicklung',
    description: 'Bargeld in der Hand oder Sofort-Überweisung - Sie entscheiden.',
    benefits: ['Keine Wartezeiten', 'Kostenfreie Abmeldung', 'Vollständige Abwicklung']
  }
];
    ...
    <ParallaxProvider>
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1718893141076-49d82fdb2e51?q=80&w=2038&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            <motion.span
              ...
              viewport={{ once: true }}
              className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 text-primary mb-4 sm:mb-6"
            >
              <div className="flex items-center space-x-2">
                <Clock className="w-3.5 sm:w-4 h-3.5 sm:h-4" />
                <span className="text-sm sm:text-base">Schneller als das BVB-Stadion voll ist</span>
              </div>
            </motion.span>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              Autoverkauf im
              <span className="text-primary"> Ruhrpott-Tempo</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Von Phoenix-West bis Nordstadt - Ihr Auto ist in 30 Minuten verkauft
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Shield, text: 'TÜV-geprüfter Ankauf' },
              { icon: Star, text: 'Dortmunder Bestpreise' },
