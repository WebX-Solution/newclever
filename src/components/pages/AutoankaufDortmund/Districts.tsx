...
export default function Districts() {
  const districts = [
    {
      name: 'Innenstadt',
      areas: ['City', 'Klinikviertel', 'Nordstadt', 'Kaiserviertel'],
      description: 'Direkt am U-Turm',
      highlights: ['Ankauf beim Shoppen', 'City-Garage? Kein Problem', 'Blitz-Abwicklung']
    },
    {
      name: 'Hörde',
      areas: ['Alt-Hörde', 'Phoenix-See', 'Clarenberg', 'Hörde-Zentrum'],
      description: 'Vom Phoenix zum Cash',
      highlights: ['Luxus-Karren ok', 'See-Service', 'Sofort-Deal am Wasser']
    },
    {
      name: 'Hombruch',
      areas: ['Hombruch', 'Barop', 'Eichlinghofen', 'Kruckel'],
      description: 'Uni-Viertel Express',
      highlights: ['Studentenautos welcome', 'Semesterend-Service', 'Direkt-Cash']
    },
    {
      name: 'Brackel',
      areas: ['Brackel', 'Asseln', 'Wickede', 'Wambel'],
      description: 'BVB-Trainingsgelände? Da!',
      highlights: ['Sportwagenankauf', 'Auch Firmenwagen', 'Express vor Ort']
    },
    {
      name: 'Eving',
      areas: ['Eving', 'Lindenhorst', 'Kemminghausen', 'Holthausen'],
      description: 'Schnell wie Kohle & Stahl',
      highlights: ['Industriefahrzeuge ok', 'Schicht-Service', 'Nachts möglich']
    },
    {
      name: 'Scharnhorst',
      areas: ['Scharnhorst', 'Alt-Scharnhorst', 'Hostedde', 'Grevel'],
      description: 'B236-Express Vor Ort',
      highlights: ['Ankauf mit Mängeln', 'Direkt-Abholung', 'Sofort-Bargeld']
    },
    {
      name: 'Aplerbeck',
      areas: ['Aplerbeck', 'Berghofen', 'Schüren', 'Sölde'],
      description: 'Südost-Champion am Start',
      highlights: ['Gewerbepark-Service', 'Auch Transporter', 'Blitz-Deal']
    },
    {
      name: 'Mengede',
      areas: ['Mengede', 'Nette', 'Oestrich', 'Westerfilde'],
      description: 'Zechen-Express am Start',
      highlights: ['Diesel? Kein Problem', 'Zechenstraßen-Service', 'Sofort-Zusage']
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          >
            ...
            <span className="text-primary text-sm sm:text-base font-medium">Alle Dortmunder Stadtteile</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Wir sind in allen Dortmunder Stadtteilen für Sie da
          </motion.p>
        </div>
