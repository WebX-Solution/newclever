    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1718893141076-49d82fdb2e51?q=80&w=2038&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Ihr Autoankauf-Experte im Ruhrpott</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Autoverkauf Dortmund</span>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Dortmunds schnellster Autoankauf – von Hörde bis Brackel. 
                  <span className="text-primary font-medium"> Ohne Wartezeit, ohne Papierkram</span>. 
                  Wir kommen zu Ihnen, egal ob Firmenhof oder Haustür.
                </p>
              </div>
              ...
              >
                <a
                  href="/kontakt"
                  className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl bg-primary text-white text-sm sm:text-base font-medium hover:bg-primary-dark transition-all duration-300"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl bg-white/10 text-white text-sm sm:text-base font-medium hover:bg-white/20 transition-all duration-300 backdrop-blur-sm"
                >
              ...
              >
                {[
                  'Direktauszahlung vor Ort',
                  'Kostenlose Abholung',
                  'Höchstpreisversprechen',
                ].map((text, index) => (
                  <div 
                    key={index} 
                ...
                {[
                  {
                    ...
                    description: 'Von Audi bis VW, von Neuwagen bis Oldtimer',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Dortmund-Bonus',
                    description: 'Lokale Bestpreise garantiert',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'BVB-Stadt-Service',
                    description: 'Ankauf in allen Stadtbezirken',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Express-Vor-Ort',
                    description: 'Innerhalb 30 Minuten bei Ihnen',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
