...
const steps = [
  {
    icon: Phone,
    title: 'Erstkontakt',
    description: 'Direkte Leitung zu unserem Alster-Office.',
    benefits: ['Hafenstadt-Hotline', 'Schnelle Ansprechpartner', 'Maritimer Service']
  },
  {
    icon: Car,
    title: 'Dockside Check',
    description: 'Fahrzeugcheck mit Hamburger Präzision.',
    benefits: ['Hafen-Standards', 'Elb-Express Service', 'Technische Klarheit']
  },
  {
    icon: BadgeEuro,
    title: 'Hanseatisches Angebot',
    description: 'Kaufmännisch fair kalkuliert.',
    benefits: ['Handelskammer-Niveau', 'Ehrliche Preise', 'Hafenstadt-Garantie']
  },
  {
    icon: Banknote,
    title: 'Hamburger Transfer',
    description: 'Schnell wie der Containerumschlag.',
    benefits: ['Blitzüberweisung', 'Hafenlogistik', 'Express-Abholung']
  }
];
    ...
    <ParallaxProvider>
      <section className="py-12 sm:py-20 md:py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1704833111036-ad4ef94cb656')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihr Auto in Hamburg bei uns
            </motion.p>
          </div>
          ...
          >
            {[
              ...
              { icon: MapPin, text: 'Alle Hamburger Bezirke' }
            ].map((indicator, index) => (
