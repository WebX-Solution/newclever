...
export default function MainContent() {
  const serviceLinks = [
    { path: "/hamburg/gebrauchtwagen-ankauf", text: "Gebrauchtwagen Ankauf Hamburg" },
    { path: "/hamburg/unfallwagen-ankauf", text: "Unfallwagen Ankauf Hamburg" },
    { path: "/hamburg/firmenwagen-ankauf", text: "Firmenwagen Ankauf Hamburg" },
    { path: "/hamburg/motorschaden-ankauf", text: "Motorschaden Ankauf Hamburg" },
    { path: "/hamburg/kfz-ankauf", text: "KFZ Ankauf Hamburg" },
    { path: "/hamburg/pkw-ankauf", text: "PKW Ankauf Hamburg" },
  ];

  const features = [
    {
      icon: Car,
      title: 'Mobiles Team Hamburg',
      description: 'Von Blankenese bis Bergedorf',
      benefits: [
        'Termin am gleichen Tag',
        'Anfahrt kostenfrei',
        'Ankauf direkt vor Ort',
        'Abholung inklusive'
      ]
    },
    {
      icon: BadgeEuro,
      title: 'Ehrlicher Preis',
      description: 'Keine Versteckspiele',
      benefits: [
        'Preisgarantie per WhatsApp',
        'Bezahlung wie gewünscht',
        'Keine Abzüge später',
        'Höchstpreise beweisbar'
      ]
    },
    {
      icon: Shield,
      title: 'Hamburger Service',
      description: 'Moin, wir sind für Sie da',
      benefits: [
        'Auch abends bis 22 Uhr',
        'Ankauf am Wochenende',
        'Sofort-Abmeldung',
  ...
  const mainContentText = {
    title: "Autoankauf Hamburg - schnell, fair, hanseatisch",
    paragraphs: [
      "Hamburger Autoverkauf muss nicht kompliziert sein. Von der Elbe bis zur Alster, von Altona bis Wandsbek: In maximal 35 Minuten sind wir bei Ihnen. Ein kurzer Check, ein faires Angebot, sofortige Bezahlung. Fertig.",
      
      "Keine Zeit für lange Besichtigungen? Schicken Sie uns Fotos per WhatsApp. Sie bekommen eine verbindliche Preiszusage - garantiert ohne Tricks und Nachverhandlungen. Der zugesagte Preis wird gezahlt, bar oder per Sofortüberweisung.",
      
      "Egal ob Ihr Wagen top gepflegt ist oder ein paar Macken hat: Wir kaufen jedes Auto. Auch Unfallwagen und Autos mit Motorschaden. Die Abmeldung erledigen wir noch am selben Tag. Einfacher geht's nicht in Hamburg."
    ]
  };

  const specializedServicesContent = {
    title: "Autoankauf überall in Hamburg",
    description: "Ob auf St. Pauli oder in Harburg, ob an den Landungsbrücken oder in Rahlstedt: Wir kommen zu Ihnen und kaufen Ihr Auto zum fairen Preis. Direkt, ehrlich, ohne Umwege."
  };

  const regionalExpertiseContent = {
    title: "Hamburg und Umgebung",
    description: "Von der City bis ins Umland: Unser Team ist täglich im Großraum Hamburg unterwegs. Mit direkter Abwicklung und flexiblen Terminen machen wir den Verkauf so einfach wie möglich."
  };

  const relatedServicesContent = {
    title: "Verwandte Dienstleistungen",
    description: "Entdecken Sie unsere spezialisierten Dienstleistungen für den Autoankauf in Hamburg und Umgebung."
  };
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              ...
              <span className="text-primary text-sm sm:text-base font-medium">Autoankauf Experten Hamburg</span>
            </motion.div>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Profitieren Sie von unserem professionellen Autoankauf Service in Hamburg.
          ...
          <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 md:space-y-20">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    { to: "/hamburg/motorschaden-ankauf", text: "Motorschaden Ankauf", icon: Car },
                    { to: "/hamburg/kfz-ankauf", text: "KFZ Ankauf", icon: BadgeCheck },
                    { to: "/hamburg/pkw-ankauf", text: "PKW Ankauf", icon: Shield }
                  ].map((service, index) => (
                    <Link
                      key={index}
                      to={service.to}
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 sm:mb-6 relative z-10">
                Jetzt Auto in Hamburg verkaufen
              </h3>
              <p className="text-sm sm:text-base md:text-xl text-gray-300 mb-4 sm:mb-8 max-w-2xl mx-auto relative z-10">
                ...
                Wir sind in ganz Hamburg für Sie da.
              </p>
