          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf Hamburg</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Hamburger Hafenservice für Ihren Autoverkauf</span>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Von Blankenese bis zur HafenCity - 
                  <span className="text-primary font-medium"> maritime Effizienz</span> beim Autoankauf. 
                  Hafenschnell und hanseatisch fair.
                </p>
              </div>
                ...
                {[
                  {
                    icon: Car,
                    title: 'Hafen-Express',
                    description: 'Service von Dock zu Dock',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Handel & Logistik',
                    description: 'Hanseatische Abwicklung',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Hafenqualität',
                    description: 'Zertifizierte Bewertung',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Elb-Coverage',
                    description: 'Von Wedel bis Bergedorf',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
