...
export default function FAQ() {
  const faqs = [
    {
      question: 'Wie läuft der KFZ Ankauf ab?',
    ...
    {
      question: 'Welche Unterlagen werden beim KFZ Ankauf benötigt?',
      answer: 'Für den Verkauf Ihres KFZs benötigen wir: Fahrzeugschein, Fahrzeugbrief, Service-Heft (falls vorhanden), gültige HU/AU, alle Fahrzeugschlüssel und Ihren Personalausweis.'
    },
    {
      question: 'Wie wird der Preis für mein KFZ ermittelt?',
    ...
    },
    {
      ...
      answer: 'Ja, wir kaufen auch KFZs mit technischen Mängeln, hoher Laufleistung oder Unfallschäden. Eine faire Bewertung erfolgt nach Begutachtung des Fahrzeugs.'
    },
    {
      question: 'Ist eine Abholung des KFZs möglich?',
    ...
    <section className="py-32 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          >
            Hier finden Sie Antworten auf die wichtigsten Fragen rund um den KFZ Ankauf
          </motion.p>
        </div>
