...
export default function TrustIndicators() {
  const stats = [
    { number: '20000+', label: 'KFZ angekauft' },
  ...
  const vehicleTypes = [
    'Personenkraftwagen', 'Nutzfahrzeuge', 'Transporter', 'Geländewagen',
    'Sportwagen', 'Elektrofahrzeuge', 'Hybridfahrzeuge', 'Oldtimer',
    'Youngtimer', 'Luxusfahrzeuge', 'Cabriolets', 'Vans'
  ];
