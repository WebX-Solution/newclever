...
export default function MainContent({ city = 'Berlin' }) {
  const features = [
    {
      icon: Car,
      title: 'Alle KFZ Typen',
      description: 'Ankauf von Kraftfahrzeugen aller Art',
      benefits: [
        'PKW & Nutzfahrzeuge',
        'Transporter & Vans',
        'Elektro & Hybrid',
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            >
              ...
              <span className="text-primary font-medium">KFZ Ankauf Experten in {city}</span>
            </motion.div>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              KFZ Ankauf
              <span className="text-primary"> in {city} zum Bestpreis</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Profitieren Sie von unserem professionellen KFZ Ankauf Service in {city}.
              Faire Preise und schnelle Abwicklung bundesweit.
            </motion.p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-20">
            ...
            >
              <h3 className="text-3xl font-bold mb-6">
                Warum Sie Ihr KFZ bei uns verkaufen sollten
              </h3>
              <p className="text-gray-600">
                Als erfahrener Partner im KFZ Ankauf bieten wir Ihnen einen
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                Unser KFZ Ankauf Service ist in {city} und ganz Deutschland verfügbar.
                Wir kommen kostenlos zu Ihnen und bewerten Ihr Fahrzeug vor Ort.
                Profitieren Sie von unserem bundesweiten Netzwerk und verkaufen Sie
                Ihr KFZ schnell und unkompliziert.
              </p>
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-white mb-6 relative z-10">
                Jetzt KFZ in {city} verkaufen
              </h3>
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto relative z-10">
                Kontaktieren Sie uns für eine kostenlose Bewertung Ihres KFZs in {city}.
