...
export default function TrustIndicators() {
  const stats = [
    { number: '5000+', label: 'Autos in Berlin angekauft' },
          ...
          {stats.map((stat, index) => (
            ...
            >
              <motion.div
                ...
                className="relative p-4 sm:p-6 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10"
              >
      ...
      <div className="container mx-auto px-4 mb-8 sm:mb-12 md:mb-16">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Berlinern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
