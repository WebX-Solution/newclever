    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1599946347371-68eb71b16afc?auto=format&fit=crop&q=80)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf Berlin</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Autoankauf Berlin</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dark">
                    <TypeAnimation
                      sequence={[
                        'ohne Händler-Trickserei',
                        2000,
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Von Spandau bis Köpenick in 30 Minuten vor Ort. 
                  <span className="text-primary font-medium"> Bar auf die Hand</span> oder 
                  Express-Überweisung noch während der Besichtigung.
                </p>
              </div>
                ...
                {[
                  {
                    icon: Car,
                    title: 'Egal was',
                    description: 'TÜV, Unfallschaden, Motorschaden? Wir kaufen!',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Echte Kohle',
                    description: 'Bar oder Express-Banking in 5 Minuten',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Ehrlich hier',
                    description: 'Keine Händler-Maschen, kein Preispoker',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Überall',
                    description: 'Alle Bezirke, alle Stadtteile, 24/7',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
