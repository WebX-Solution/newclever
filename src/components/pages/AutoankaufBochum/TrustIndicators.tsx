...
export default function TrustIndicators() {
  const stats = [
    { number: '1000+', label: 'Autos in Bochum angekauft' },
  ...
  const districts = [
    'Innenstadt', 'Wattenscheid', 'Langendreer', 'Weitmar',
    'Wiemelhausen', 'Querenburg', 'Harpen', 'Gerthe',
    'Riemke', 'Höntrop', 'Linden', 'Dahlhausen'
  ];
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="flex flex-wrap justify-center gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Bochumern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
