    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1704833111036-ad4ef94cb656?q=80&w=2154&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf Bochum</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Autoankauf Bochum</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dark">
                    <TypeAnimation
                      sequence={[
                        'Malocher-Preise',
                        2000,
                        'ohne Händler-Geschwätz',
                        2000,
                        'direkt anne Haustür',
                        2000
                      ]}
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Von Wattenscheid bis Langendreer: In 30 Minuten bei dir. 
                  <span className="text-primary font-medium"> Hömma, bei uns gibts Kohle direkt</span> - 
                  Bar oder Blitz-Überweisung noch vorm Feierabend.
                </p>
              </div>
                ...
                {[
                  {
                    icon: Car,
                    title: 'Komma bei',
                    description: 'Motorschaden? TÜV weg? Is uns wurscht!',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Bares is Wahres',
                    description: 'Direktzahlung ohne Firlefanz',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Klare Kante',
                    description: 'Ein Wort, ein Preis, ein Deal',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'Überall da',
                    description: 'Vom Bermuda3eck bis RuhrPark',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
