...
export default function TrustIndicators() {
  const stats = [
    { number: '10000+', label: 'Autos in Düsseldorf angekauft' },
  ...
  const districts = [
    'Stadtmitte', 'Flingern', 'Bilk', 'Pempelfort',
    'Derendorf', 'Oberkassel', 'Gerresheim', 'Benrath',
    'Eller', 'Unterbilk', 'Golzheim', 'Friedrichstadt'
  ];
      ...
      <div className="container mx-auto px-4 mb-8 sm:mb-12 md:mb-16">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8">
          {[
            ...
            { icon: MapPin, text: 'Alle Düsseldorfer Stadtteile' },
            { icon: ThumbsUp, text: 'Empfohlen von Düsseldorfern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
