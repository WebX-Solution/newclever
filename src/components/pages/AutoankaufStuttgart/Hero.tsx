    ...
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1577465726297-3b2b9bf872d0?auto=format&fit=crop&q=80)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
                ...
                <span className="text-white text-xs sm:text-sm">Autoankauf Stuttgart</span>
              </div>

              {/* Main Heading with Typing Animation */}
              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  <span className="block">Stuttgarter Autoankauf</span>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl">
                  Von Zuffenhausen bis zum Neckarpark - 
                  <span className="text-primary font-medium"> kompetenter Service</span> mit 
                  Automobil-DNA. Schnell. Direkt. Schwäbisch fair.
                </p>
              </div>
            ...
            >
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  {
                    icon: Car,
                    title: 'Automobil-Expertise',
                    description: 'Vom Käfer bis zum Sportwagen',
                    delay: 0
                  },
                  {
                    icon: BadgeEuro,
                    title: 'Neckar-Preise',
                    description: 'Schwäbisch fair kalkuliert',
                    delay: 0.2
                  },
                  {
                    icon: Shield,
                    title: 'Königstraßen-Service',
                    description: 'Zentral & zuverlässig',
                    delay: 0.4
                  },
                  {
                    icon: MapPin,
                    title: 'S-Mobilität',
                    description: 'Von Feuerbach bis Degerloch',
                    delay: 0.6
                  }
                ].map((feature, index) => (
                  <motion.div
