...
const steps = [
  {
    icon: Phone,
    title: 'Stuttgart kontaktieren',
    description: 'Vom Porsche-Museum bis zum Fernsehturm - wir sind in 20 Minuten vor Ort.',
    benefits: ['Kessel-City-Service', 'Stuttgarter Direktlinie', 'Auch per WhatsApp']
  },
  {
    icon: Car,
    title: 'Werks-Check',
    description: 'Automotive-Expertise aus der Porsche & Mercedes-Stadt.',
    benefits: ['Zuffenhausen-Standard', 'Untertürkheim-Know-how', 'Schnelldiagnose']
  },
  {
    icon: BadgeEuro,
    title: 'Kessel-Preise',
    description: 'Schwäbisch kalkuliert - fair wie der Schlossplatz.',
    benefits: ['Automotive-City-Bonus', 'Händlernetzwerk-Vorteil', 'Festpreis-Garantie']
  },
  {
    icon: Banknote,
    title: 'Stuttgart-Speed',
    description: 'So schnell wie die B14 durch die City - in 30 Minuten erledigt.',
    benefits: ['Sofort-Überweisung', 'Expresszahlung Bar', 'Kostenlose Abmeldung']
  }
];
    ...
    <ParallaxProvider>
      <section className="py-12 sm:py-20 md:py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1577465726297-3b2b9bf872d0')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
            ...
            >
              Schnell, transparent und unkompliziert - so verkaufen Sie Ihr Auto in Stuttgart bei uns
            </motion.p>
          </div>
          ...
          >
            {[
              ...
              { icon: MapPin, text: 'Alle Stuttgarter Stadtteile' }
            ].map((indicator, index) => (
