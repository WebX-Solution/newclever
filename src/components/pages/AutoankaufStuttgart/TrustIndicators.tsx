...
export default function TrustIndicators() {
  const stats = [
    { number: '1900+', label: 'Autos in Stuttgart angekauft' },
  ...
  const districts = [
    'Bad Cannstatt', 'Feuerbach', 'Vaihingen', 'Zuffenhausen',
    'Degerloch', 'Möhringen', 'Stammheim', 'Weilimdorf',
    'Untertürkheim', 'Sillenbuch', 'Plieningen', 'Botnang'
  ];
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8">
          {[
            ...
            { icon: ThumbsUp, text: 'Empfohlen von Stuttgartern' }
          ].map((badge, index) => (
            <motion.div
              key={index}
