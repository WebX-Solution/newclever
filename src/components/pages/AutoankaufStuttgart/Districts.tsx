...
export default function Districts() {
  const districts = [
    {
      name: 'Bad Cannstatt',
      areas: ['Bad Cannstatt', 'Münster', 'Neckarvorstadt', 'Hallschlag'],
      description: 'Direkt am Neckar - Ankauf mit Tradition',
      highlights: ['Cannstatter-Wasen-Service', 'Mercedes-Arena-Nähe', 'Mineralwasser-Express']
    },
    {
      name: 'Feuerbach',
      areas: ['Feuerbach', 'Siegelberg', 'Feuerbacher Tal', 'Hofen'],
      description: 'Industrieviertel-Spezialist am Pragsattel',
      highlights: ['Bosch-Expertise', 'Porsche-Nähe', 'B10/B27-Service']
    },
    {
      name: 'Vaihingen',
      areas: ['Vaihingen', 'Rohr', 'Dürrlewang', 'Büsnau'],
      description: 'Uni-Campus & Technologie-Park',
      highlights: ['S-Bahn-City-Service', 'Campus-Express', 'Synergie-Park-Abholung']
    },
    {
      name: 'Zuffenhausen',
      areas: ['Zuffenhausen', 'Rot', 'Zazenhausen', 'Neuwirtshaus'],
      description: 'Porsche-Heimat Expertise',
      highlights: ['Werksnaher Service', 'Sportwagen-Kompetenz', 'Traditions-Bewertung']
    },
    {
      name: 'Degerloch',
      areas: ['Degerloch', 'Waldau', 'Haigst', 'Tränke'],
      description: 'Höhenlage-Ankauf mit Weitblick',
      highlights: ['Zahnradbahn-Express', 'TV-Turm-Service', 'Waldrand-Abholung']
    },
    {
      name: 'Möhringen',
      areas: ['Möhringen', 'Fasanenhof', 'Sonnenberg', 'Wallgraben'],
      description: 'SI-Centrum & Filderbahnplatz',
      highlights: ['Airport-Connection', 'Musical-Service', 'Filderstadt-Express']
    },
    {
      name: 'Stammheim',
      areas: ['Stammheim', 'Neustammheim', 'Altstammheim', 'Hohlgrabenäcker'],
      description: 'Neckartal-Expertise',
      highlights: ['Industriegebiet-Service', 'Schnellstraßen-Nähe', 'Neckar-Express']
    },
    {
      name: 'Weilimdorf',
      areas: ['Weilimdorf', 'Bergheim', 'Giebel', 'Wolfbusch'],
      description: 'Solitude-Service & Salamander-Areal',
      highlights: ['Gewerbepark-Kompetenz', 'A81-Anschluss', 'Schnellankauf']
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-20">
          ...
          >
            ...
            <span className="text-primary text-sm sm:text-base font-medium">Alle Stuttgarter Stadtteile</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Wir sind in allen Stuttgarter Stadtteilen für Sie da
          </motion.p>
        </div>
